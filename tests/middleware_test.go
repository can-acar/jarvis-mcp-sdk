...
func TestJWTMiddleware(t *testing.T) {
	...
	t.Skip("JWT test temporarily skipped due to token/secret mismatch - needs proper JWT library for token generation")
	...
	// Use a token generated with "test-secret"
	// Contains: {"sub":"test-user","name":"Test User","roles":["user"],"exp":9999999999}
	token := "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0LXVzZXIiLCJuYW1lIjoiVGVzdCBVc2VyIiwicm9sZXMiOlsidXNlciJdLCJleHAiOjk5OTk5OTk5OTl9.qhqb-HeBEHZLKcN7fKnSqZP6jrVxYSr_W6pf1_PJ-JU"
